	...
	@section( "cuerpo" )
		<h1 class="mt-5 shadow p-3 mb-5 bg-white rounded text-danger">Consulta Polizas Vencimiento en 15 Días</h1>
		<ul class="nav justify-content-end">
		  <li class="nav-item">
		      <a class="btn btn-outline-primary" href="/consultas/">Regresar</a>
		      <a class="btn btn-outline-success" href="/polizas7/export7/">Exporta Excel</a>
		    </li>
		</ul>
		<hr style="border:2px;">
		<form method="get" action="/consult/polizas7/" autocomplete="off" role="search" >
